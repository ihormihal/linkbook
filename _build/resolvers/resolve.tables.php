...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('linkbook_core_path', null, $modx->getOption('core_path') . 'components/linkbook/') . 'model/';
            $modx->addPackage('linkbook', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/linkbook/model/schema/linkbook.mysql.schema.xml';
