 ...
 * Update an Item
 */
class linkBookOfficeItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('linkbook_item_err_ns');
		}
...
return 'linkBookOfficeItemUpdateProcessor';
