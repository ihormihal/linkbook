 ...
 * Get a list of Items
 */
class linkBookOfficeItemGetListProcessor extends modObjectGetListProcessor {
	...
	public function prepareRow(xPDOObject $object) {
		...
		$array['actions'][] = array(
			'cls' => '',
			'icon' => 'fa fa-edit',
			'title' => $this->modx->lexicon('linkbook_item_update'),
			//'multiple' => $this->modx->lexicon('linkbook_items_update'),
			'action' => 'updateItem',
			'button' => true,
			'menu' => true,
		);
		...
		$array['actions'][] = array(
			...
			'title' => $this->modx->lexicon('linkbook_item_remove'),
			'multiple' => $this->modx->lexicon('linkbook_items_remove'),
			'action' => 'removeItem',
			'button' => true,
			'menu' => true,
		);
...
return 'linkBookOfficeItemGetListProcessor';